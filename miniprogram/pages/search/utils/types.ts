...
export interface SearchPageContext extends WechatMiniprogram.Page.Instance<SearchPageData, SearchPageMethods> {
  ...
  _setDefaultImageForFood: typeof import('./imageHandlers')._setDefaultImageForFood;
  onImgError: typeof import('./imageHandlers').onImgError;
