...
// 导入所有需要的函数
// 新的导入方式
import { loadAllFoodData, proactiveLoadNeighborImages } from './utils/dataHandlers';
import { onImgError as handleImgError, _setDefaultImageForFood, loadLazyImage } from './utils/imageHandlers';
